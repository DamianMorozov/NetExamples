...
namespace WPF.Net.Examples.Views
{
    public partial class PageBrowseSharp
    {
        ...
        public async void ButtonBrowseSharp_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            var response1 = browser.NavigateAsync(AppSettings.BrowseSharpUrl, headers).GetAwaiter().GetResult();
            ...
            var response2 = browser.NavigateAsync(AppSettings.BrowseSharpUrl, headers, formData).GetAwaiter().GetResult();
            ...
            // Form as dictionary
            var response3 = await browser.SubmitAsync("https://www.hashemian.com/tools/form-post-tester.php", formData);

            // With headers
            var response4 = await browser.SubmitAsync("https://requesttester.com", formData, headers);

            // Async calls
            var response5 = await browser.NavigateAsync("https://www.browsesharp.org/testsitesforms.html");
            ...
            // Output
            var requestedDocument = browser.Documents[0];
